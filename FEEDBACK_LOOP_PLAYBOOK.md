...
- Review the current branch/PR and scan the whole project (modules/toc, code, scripts, tests) for metadata, geometry, or logic regressions. Anchor on best practices: understand intent, check correctness and edge cases, keep comments/ids clear, prefer small focused diffs, and leave actionable, concise feedback.
